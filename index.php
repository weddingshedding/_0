...
<main>
  <section class="hero">
    ...
    <?php else: ?>
      <img class="hero-bg" src="<?= e(setting('hero_background_image', 'assets/images/hero-placeholder.svg')) ?>" alt="Wedding Shedding cinematic wedding background" loading="eager">
    <?php endif; ?>
