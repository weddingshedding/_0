...
<head>
  ...
  <meta property="og:image" content="<?= e(site_url(setting('hero_background_image', 'assets/images/hero-placeholder.svg'))) ?>">
...
<a class="secret-admin" href="admin/index.php" aria-label="Secret Admin Button">SONU</a>
